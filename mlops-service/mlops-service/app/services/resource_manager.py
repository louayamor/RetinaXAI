...
from app.services.training_service import get_active_jobs_count
from monitoring.prometheus_metrics import TRAINING_REJECTIONS_TOTAL, TRAINING_SLOTS_USED
