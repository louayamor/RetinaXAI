...
def save_region_png(image_bgr: np.ndarray, images_dir: Path, patient_id: str, region_name: str) -> Path:
...
def export_regions(
    ...
    for region_name, image_bgr in crops.items():
        try:
            png_path = save_region_png(image_bgr, images_dir, patient_id, region_name)
